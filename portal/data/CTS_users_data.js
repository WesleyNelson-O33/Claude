...
window.CTS_USERS = {
  ...
  PAGES: [
    ...
    { id: "story",        section: "Dashboard",   title: "The Month" },
    ...
    { id: "rev-forecast", section: "Revenue",     title: "Revenue Forecast" },
    ...
    { id: "charts",       section: "Finance",     title: "Trends" },
  ...
  ROLES: [
    {
      ...
      pages: ["home","context","story","commentary","pnl","pnl-dept","pnl-spread","allocation","control",
              "bva","actions","forecast","cash","rev-summary","rev-schedule","rev-forecast","pipeline","clients","client-dept",
              "util","profit-fte","staff-profit","ledger","charts","setup","build",
    ...
    },
    {
      ...
      note: "The whole company result, but not the ledger or the workings.",
      pages: ["home","context","story","commentary","pnl","pnl-dept","pnl-spread","bva","actions","forecast","cash",
    ...
    },
    {
      ...
      pages: ["home","context","story","commentary","pnl-dept","forecast","rev-schedule","rev-forecast","pipeline","clients","util","charts","about"],
    },
    {
      id: "viewer", label: "Viewer", admin: false, ownDeptOnly: false,
      note: "The headline result and the context behind it, nothing else.",
      pages: ["home","context","story","about"],
    },
  ],
